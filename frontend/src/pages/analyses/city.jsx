...
const cityData = {
  Istanbul: {
    ...
    seasonal: [
      { season: "Spring", product: "Fiber Modem", units: 3250 },
      { season: "Summer", product: "5G SIM Card", units: 9200 },
      { season: "Autumn", product: "Wi-Fi 6 Router", units: 4800 },
      { season: "Winter", product: "Fiber Modem", units: 2900 },
    ],
  },
  Ankara: {
    bestSellers: [
    ...
    seasonal: [
      { season: "Spring", product: "Home Router", units: 1400 },
      { season: "Summer", product: "IP Telephone", units: 1150 },
      { season: "Autumn", product: "Home Router", units: 1800 },
      { season: "Winter", product: "Ethernet Switch", units: 1600 },
    ],
  },
  Izmir: {
    bestSellers: [
    ...
    seasonal: [
      { season: "Spring", product: "Signal Repeater", units: 980 },
      { season: "Summer", product: "Fiber Cable", units: 1450 },
      { season: "Autumn", product: "Signal Repeater", units: 1120 },
      { season: "Winter", product: "Patch Cable", units: 890 },
    ],
  },
  Antalya: {
    bestSellers: [
    ...
    seasonal: [
      { season: "Spring", product: "TV Service Box", units: 620 },
      { season: "Summer", product: "TV Service Box", units: 1900 },
...
const KPI_OVERVIEW = {
  Istanbul: { stockUtilization: 82, salesTarget: 91 },
  Ankara: { stockUtilization: 69, salesTarget: 84 },
  Izmir: { stockUtilization: 74, salesTarget: 77 },
  Antalya: { stockUtilization: 88, salesTarget: 92 },
};
...
/* ------------------------------------------------------------------ */
/*  Reusable card shell (identical to the Dashboard / Product pages,   */
/*  padding tightened only so the page fits without scrolling)         */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  1. Turkey map backdrop + pins (unchanged from the previous turn)   */
/* ------------------------------------------------------------------ */
  ...
  return (
    <Card style={{ flex: 1, minHeight: 0, ...style }}>
      ...
      >
        ...
        <svg viewBox="0 0 700 380" style={{ width: "100%", height: "100%", display: "block" }}>
          <defs>
...
/* ------------------------------------------------------------------ */
/*  4. Seasonal product sales — line chart                             */
/* ------------------------------------------------------------------ */

function SeasonalDot(props) {
...
function SeasonalSalesCard({ selectedCity, style }) {
  const data = cityData[selectedCity].seasonal;
  return (
    <Card style={{ flex: 1, minHeight: 0, ...style }}>
...
export default function CityDashboardPage() {
  ...
  const { stockUtilization, salesTarget } = KPI_OVERVIEW[selectedCity];
